...
const contentSecurityPolicy = [
  ...
  "form-action 'self'",
  "img-src 'self' data: blob: https://images.unsplash.com https://www.vistabylara.com https://api.qrserver.com https://www.googletagmanager.com https://www.google-analytics.com https://www.google.com https://www.google.ae",
  "font-src 'self' data:",
  ...
  "child-src 'self' blob: https://www.googletagmanager.com https://my.spline.design",
  "frame-src 'self' blob: https://www.googletagmanager.com https://my.spline.design",
  "media-src 'self' blob:",
  "manifest-src 'self'",
