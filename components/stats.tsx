          ...
          <div className="flex flex-col gap-10">
            ...
            <Reveal>
              <div className="border-b border-background/15 pb-10">
                <p className="font-heading text-[5.5rem] font-medium leading-[0.9] tracking-tight text-balance sm:text-[7rem]">
                  <Counter value={FEATURED.value} suffix={FEATURED.suffix} />
                </p>
                <p className="mt-5 max-w-sm text-base leading-relaxed text-background/70">{FEATURED.label}</p>
              </div>
            </Reveal>
