    ...
    >
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-12rem)] w-full max-w-7xl items-center gap-12 lg:grid-cols-[1.02fr_0.98fr]">
        <div className="order-2 flex flex-col items-start text-left lg:order-1">
          ...
          <h1 className="vista-reveal-in vista-delay-160 max-w-5xl font-heading text-4xl font-extrabold leading-[0.98] tracking-[-0.045em] text-foreground text-balance sm:text-6xl lg:text-[5.35rem]">
          ...
          <p className="vista-reveal-in vista-delay-260 mt-7 max-w-2xl text-lg leading-8 text-muted-foreground/92 sm:text-xl">
          ...
          <div className="vista-reveal-in vista-delay-360 mt-10 flex w-full flex-col gap-4 sm:w-auto sm:flex-row">
            <a
